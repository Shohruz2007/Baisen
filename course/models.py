...
class Course(TranslatableModel):
    ...
    course_type = models.ForeignKey(
        CourseType, on_delete=models.CASCADE, related_name="type"
    )
...
class CourseDataTheme(TranslatableModel):
    ...
    subcategory = models.ForeignKey(
        CourseDataSubCategory, on_delete=models.SET_NULL, null=True, blank=True
    )


class CourseThemeTask(TranslatableModel):
    translations = TranslatedFields(content=models.TextField())
    course_theme = models.OneToOneField(
        CourseDataTheme, on_delete=models.CASCADE, related_name="theme"
    )
...
class RegisterCourseUser(models.Model):
    ...
    course = models.ForeignKey(
        Course, on_delete=models.CASCADE, related_name="registercourse"
    )
    time_create = models.DateTimeField(auto_now_add=True, null=True)
    time_update = models.DateTimeField(auto_now=True)
